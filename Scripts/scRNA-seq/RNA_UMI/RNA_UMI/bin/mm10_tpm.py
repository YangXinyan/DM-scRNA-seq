...
with open('/WPSnew/dongji/software/anaconda/lib/python2.7/site-packages/RNA_UMI/bin/mm10_genelist/genelist.xls','r') as list:
    for s in list:
        s=s.strip()
        if s in gene_count:
...
with open('/WPSnew/dongji/software/anaconda/lib/python2.7/site-packages/RNA_UMI/bin/mm10_genelist/list_gene_ercc.xls','r') as list:
    for s in list:
        s=s.strip()
