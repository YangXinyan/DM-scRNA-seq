...
with open('/home/wd/xinyan/Germline/Species/Homo_sapiens/RNA_UMI/RNA_UMI/bin/GRCh38_genelist/genelist.xls','r') as list:
    for s in list:
        s=s.strip()
        if s in gene_count:
...
with open('/home/wd/xinyan/Germline/Species/Homo_sapiens/RNA_UMI/RNA_UMI/bin/GRCh38_genelist/list_gene_ercc.xls','r') as list:
    for s in list:
        s=s.strip()
