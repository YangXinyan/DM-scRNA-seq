...
with open('/home/dell/xinyan/Developmental/Homo_sapiens/RNA_UMI/RNA_UMI/bin/mm10_genelist_ROSI/genelist.txt','r') as list:
    for s in list:
        s=s.strip()
        if s in gene_count:
...
with open('/home/dell/xinyan/Developmental/Homo_sapiens/RNA_UMI/RNA_UMI/bin/mm10_genelist_ROSI/list_gene_ercc.txt','r') as list:
    for s in list:
        s=s.strip()
