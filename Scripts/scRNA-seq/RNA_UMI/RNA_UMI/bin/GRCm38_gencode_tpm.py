...
with open('/media/hobart/rash/Developmental/Species/Homo_sapiens/RNA_UMI/RNA_UMI/bin/GRCm38_gencode_genelist/genelist.txt','r') as list:
    for s in list:
        s=s.strip()
        if s in gene_count:
...
with open('/media/hobart/rash/Developmental/Species/Homo_sapiens/RNA_UMI/RNA_UMI/bin/GRCm38_gencode_genelist/list_gene_ercc.txt','r') as list:
    for s in list:
        s=s.strip()
