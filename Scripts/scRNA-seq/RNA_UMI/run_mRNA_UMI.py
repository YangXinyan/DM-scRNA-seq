...
import RNA_UMI.frame.module01_mapping_from_raw   as m01
import RNA_UMI.frame.module02_RNA_Quantification as m02
import RNA_UMI.frame.module03_Stat_Sample        as m03

import RNA_UMI.utils.module_create_database  as m_db
...
#    part0.check_files()
    ...
    part1.s001_add_UMI()
    part1.s002_trim_TSO_polyA()
    part1.s01_QC()
    part1.s02_Tophat()
    part1.s03_HTSeq_known()
    part1.s04_mergeCount()
    part1.s05_mergeTPM()
    part1.s06_mergeCount_no_ERCC()
    part1.s07_mergeTPM_no_ERCC()
